...
print(adj.r2_style.sector <- 1-((447-1)*(1-mean(fit.style.sector$r2))/(447-13-1)))
print(adj.r2_sector <- 1-((447-1)*(1-mean(fit.sector$r2))/(447-11-1)))
@
